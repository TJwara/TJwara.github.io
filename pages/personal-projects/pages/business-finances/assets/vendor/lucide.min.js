/* Vendored library: Lucide icons used by the dynamic interface. Keep upstream attribution; see README.md here. */
/**
 ...
 */
(function(a, n) {
  typeof exports == "object" && typeof module < "u" ? n(exports) : typeof define == "function" &&
    define.amd ? define(["exports"], n) : (a = typeof globalThis < "u" ? globalThis : a || self,
      n(a.lucide = {}))
})(this, function(a) {
  "use strict";
  const n = (t, d, c = []) => {
  ...
  var I0 = ([t, d, c]) => n(t, d, c);
  const Q$ = t => Array.from(t.attributes).reduce((d, c) => (d[c.name] = c.value, d), {}),
    j$ = t => typeof t == "string" ? t : !t || !t.class ? "" : t.class && typeof t.class ==
    "string" ? t.class.split(" ") : t.class && Array.isArray(t.class) ? t.class : "",
    Y$ = t => t.flatMap(j$).map(d => d.trim()).filter(Boolean).filter((d, c, p) => p.indexOf(
      d) === c).join(" "),
    _$ = t => t.replace(/(\w)(\w*)(_|-|\s*)/g, (d, c, p) => c.toUpperCase() + p.toLowerCase()),
    E0 = (t, {
      nameAttr: d,
      icons: c,
      attrs: p
...
lucide.createIcons({icons});\``);
  ...
  a.AArrowDown = x0, a.AArrowUp = W0, a.ALargeSmall = X0, a.Accessibility = N0, a.Activity = K0, a
    .ActivitySquare = L2, a.AirVent = J0, a.Airplay = Q0, a.AlarmCheck = o, a.AlarmClock = Y0, a
    .AlarmClockCheck = o, a.AlarmClockMinus = s, a.AlarmClockOff = j0, a.AlarmClockPlus = r, a
    .AlarmMinus = s, a.AlarmPlus = r, a.AlarmSmoke = _0, a.Album = aa, a.AlertCircle = G, a
    .AlertOctagon = t2, a.AlertTriangle = P0, a.AlignCenter = da, a.AlignCenterHorizontal = ha, a
    .AlignCenterVertical = ta, a.AlignEndHorizontal = ca, a.AlignEndVertical = Ma, a
    .AlignHorizontalDistributeCenter = pa, a.AlignHorizontalDistributeEnd = ea, a
    .AlignHorizontalDistributeStart = na, a.AlignHorizontalJustifyCenter = ia, a
    .AlignHorizontalJustifyEnd = la, a.AlignHorizontalJustifyStart = va, a
    .AlignHorizontalSpaceAround = oa, a.AlignHorizontalSpaceBetween = sa, a.AlignJustify = ra, a
    .AlignLeft = ga, a.AlignRight = ya, a.AlignStartHorizontal = $a, a.AlignStartVertical = ma, a
    .AlignVerticalDistributeCenter = Ca, a.AlignVerticalDistributeEnd = ua, a
    .AlignVerticalDistributeStart = Ha, a.AlignVerticalJustifyCenter = wa, a
    .AlignVerticalJustifyEnd = Va, a.AlignVerticalJustifyStart = Aa, a.AlignVerticalSpaceAround =
    Sa, a.AlignVerticalSpaceBetween = La, a.Ambulance = fa, a.Ampersand = Pa, a.Ampersands = ka, a
    .Amphora = Ba, a.Anchor = Fa, a.Angry = Da, a.Annoyed = Ra, a.Antenna = za, a.Anvil = qa, a
    .Aperture = Ta, a.AppWindow = ba, a.AppWindowMac = Za, a.Apple = Ua, a.Archive = Ia, a
    .ArchiveRestore = Oa, a.ArchiveX = Ga, a.AreaChart = P, a.Armchair = Ea, a.ArrowBigDown = Wa,
    a.ArrowBigDownDash = xa, a.ArrowBigLeft = Na, a.ArrowBigLeftDash = Xa, a.ArrowBigRight = Ja, a
    .ArrowBigRightDash = Ka, a.ArrowBigUp = ja, a.ArrowBigUpDash = Qa, a.ArrowDown = eh, a
    .ArrowDown01 = Ya, a.ArrowDown10 = _a, a.ArrowDownAZ = g, a.ArrowDownAz = g, a
    .ArrowDownCircle = I, a.ArrowDownFromLine = ah, a.ArrowDownLeft = hh, a
    .ArrowDownLeftFromCircle = x, a.ArrowDownLeftFromSquare = F2, a.ArrowDownLeftSquare = f2, a
    .ArrowDownNarrowWide = th, a.ArrowDownRight = dh, a.ArrowDownRightFromCircle = W, a
    .ArrowDownRightFromSquare = D2, a.ArrowDownRightSquare = P2, a.ArrowDownSquare = k2, a
    .ArrowDownToDot = ch, a.ArrowDownToLine = Mh, a.ArrowDownUp = ph, a.ArrowDownWideNarrow = y, a
    .ArrowDownZA = $, a.ArrowDownZa = $, a.ArrowLeft = vh, a.ArrowLeftCircle = E, a
    .ArrowLeftFromLine = nh, a.ArrowLeftRight = ih, a.ArrowLeftSquare = B2, a.ArrowLeftToLine =
    lh, a.ArrowRight = gh, a.ArrowRightCircle = K, a.ArrowRightFromLine = oh, a.ArrowRightLeft =
    sh, a.ArrowRightSquare = q2, a.ArrowRightToLine = rh, a.ArrowUp = Sh, a.ArrowUp01 = yh, a
    .ArrowUp10 = $h, a.ArrowUpAZ = m, a.ArrowUpAz = m, a.ArrowUpCircle = J, a.ArrowUpDown = mh, a
    .ArrowUpFromDot = Ch, a.ArrowUpFromLine = uh, a.ArrowUpLeft = Hh, a.ArrowUpLeftFromCircle = X,
    a.ArrowUpLeftFromSquare = R2, a.ArrowUpLeftSquare = T2, a.ArrowUpNarrowWide = C, a
    .ArrowUpRight = wh, a.ArrowUpRightFromCircle = N, a.ArrowUpRightFromSquare = z2, a
    .ArrowUpRightSquare = Z2, a.ArrowUpSquare = b2, a.ArrowUpToLine = Vh, a.ArrowUpWideNarrow =
    Ah, a.ArrowUpZA = u, a.ArrowUpZa = u, a.ArrowsUpFromLine = Lh, a.Asterisk = fh, a
    .AsteriskSquare = U2, a.AtSign = Ph, a.Atom = kh, a.AudioLines = Bh, a.AudioWaveform = Fh, a
    .Award = Dh, a.Axe = Rh, a.Axis3D = H, a.Axis3d = H, a.Baby = zh, a.Backpack = qh, a.Badge =
    jh, a.BadgeAlert = Th, a.BadgeCent = Zh, a.BadgeCheck = w, a.BadgeDollarSign = bh, a
    .BadgeEuro = Uh, a.BadgeHelp = Oh, a.BadgeIndianRupee = Gh, a.BadgeInfo = Ih, a
    .BadgeJapaneseYen = Eh, a.BadgeMinus = xh, a.BadgePercent = Wh, a.BadgePlus = Xh, a
    .BadgePoundSterling = Nh, a.BadgeRussianRuble = Kh, a.BadgeSwissFranc = Jh, a.BadgeX = Qh, a
    .BaggageClaim = Yh, a.Ban = _h, a.Banana = at, a.Bandage = ht, a.Banknote = tt, a.BarChart =
    T, a.BarChart2 = Z, a.BarChart3 = z, a.BarChart4 = R, a.BarChartBig = D, a
    .BarChartHorizontal = B, a.BarChartHorizontalBig = k, a.Barcode = dt, a.Baseline = ct, a
    .Bath = Mt, a.Battery = vt, a.BatteryCharging = pt, a.BatteryFull = et, a.BatteryLow = nt, a
    .BatteryMedium = it, a.BatteryWarning = lt, a.Beaker = ot, a.Bean = rt, a.BeanOff = st, a
    .Bed = $t, a.BedDouble = gt, a.BedSingle = yt, a.Beef = mt, a.Beer = ut, a.BeerOff = Ct, a
    .Bell = ft, a.BellDot = Ht, a.BellElectric = wt, a.BellMinus = Vt, a.BellOff = At, a
    .BellPlus = St, a.BellRing = Lt, a.BetweenHorizonalEnd = V, a.BetweenHorizonalStart = A, a
    .BetweenHorizontalEnd = V, a.BetweenHorizontalStart = A, a.BetweenVerticalEnd = Pt, a
    .BetweenVerticalStart = kt, a.BicepsFlexed = Bt, a.Bike = Ft, a.Binary = Dt, a.Binoculars =
    Rt, a.Biohazard = zt, a.Bird = qt, a.Bitcoin = Tt, a.Blend = Zt, a.Blinds = bt, a.Blocks = Ut,
    a.Bluetooth = Et, a.BluetoothConnected = Ot, a.BluetoothOff = Gt, a.BluetoothSearching = It, a
    .Bold = xt, a.Bolt = Wt, a.Bomb = Xt, a.Bone = Nt, a.Book = y4, a.BookA = Kt, a.BookAudio =
    Jt, a.BookCheck = Qt, a.BookCopy = jt, a.BookDashed = S, a.BookDown = Yt, a.BookHeadphones =
    _t, a.BookHeart = a4, a.BookImage = h4, a.BookKey = t4, a.BookLock = d4, a.BookMarked = c4, a
    .BookMinus = M4, a.BookOpen = n4, a.BookOpenCheck = p4, a.BookOpenText = e4, a.BookPlus = i4,
    a.BookTemplate = S, a.BookText = l4, a.BookType = v4, a.BookUp = s4, a.BookUp2 = o4, a
    .BookUser = r4, a.BookX = g4, a.Bookmark = H4, a.BookmarkCheck = $4, a.BookmarkMinus = m4, a
    .BookmarkPlus = C4, a.BookmarkX = u4, a.BoomBox = w4, a.Bot = S4, a.BotMessageSquare = V4, a
    .BotOff = A4, a.Box = L4, a.BoxSelect = Q2, a.Boxes = f4, a.Braces = L, a.Brackets = P4, a
    .Brain = F4, a.BrainCircuit = k4, a.BrainCog = B4, a.BrickWall = D4, a.Briefcase = T4, a
    .BriefcaseBusiness = R4, a.BriefcaseConveyorBelt = z4, a.BriefcaseMedical = q4, a
    .BringToFront = Z4, a.Brush = b4, a.Bug = G4, a.BugOff = U4, a.BugPlay = O4, a.Building = E4,
    a.Building2 = I4, a.Bus = W4, a.BusFront = x4, a.Cable = N4, a.CableCar = X4, a.Cake = J4, a
    .CakeSlice = K4, a.Calculator = Q4, a.Calendar = $5, a.Calendar1 = j4, a.CalendarArrowDown =
    Y4, a.CalendarArrowUp = _4, a.CalendarCheck = h5, a.CalendarCheck2 = a5, a.CalendarClock = t5,
    a.CalendarCog = d5, a.CalendarDays = c5, a.CalendarFold = M5, a.CalendarHeart = p5, a
    .CalendarMinus = n5, a.CalendarMinus2 = e5, a.CalendarOff = i5, a.CalendarPlus = v5, a
    .CalendarPlus2 = l5, a.CalendarRange = o5, a.CalendarSearch = s5, a.CalendarSync = r5, a
    .CalendarX = y5, a.CalendarX2 = g5, a.Camera = C5, a.CameraOff = m5, a.CandlestickChart = F, a
    .Candy = w5, a.CandyCane = u5, a.CandyOff = H5, a.Cannabis = V5, a.Captions = f, a
    .CaptionsOff = A5, a.Car = f5, a.CarFront = S5, a.CarTaxiFront = L5, a.Caravan = P5, a
    .Carrot = k5, a.CaseLower = B5, a.CaseSensitive = F5, a.CaseUpper = D5, a.CassetteTape = R5, a
    .Cast = z5, a.Castle = q5, a.Cat = T5, a.Cctv = Z5, a.ChartArea = P, a.ChartBar = B, a
    .ChartBarBig = k, a.ChartBarDecreasing = b5, a.ChartBarIncreasing = U5, a.ChartBarStacked =
    O5, a.ChartCandlestick = F, a.ChartColumn = z, a.ChartColumnBig = D, a.ChartColumnDecreasing =
    G5, a.ChartColumnIncreasing = R, a.ChartColumnStacked = I5, a.ChartGantt = E5, a.ChartLine =
    q, a.ChartNetwork = x5, a.ChartNoAxesColumn = Z, a.ChartNoAxesColumnDecreasing = W5, a
    .ChartNoAxesColumnIncreasing = T, a.ChartNoAxesCombined = X5, a.ChartNoAxesGantt = b, a
    .ChartPie = U, a.ChartScatter = O, a.ChartSpline = N5, a.Check = J5, a.CheckCheck = K5, a
    .CheckCircle = Q, a.CheckCircle2 = j, a.CheckSquare = G2, a.CheckSquare2 = I2, a.ChefHat = Q5,
    a.Cherry = j5, a.ChevronDown = Y5, a.ChevronDownCircle = Y, a.ChevronDownSquare = E2, a
    .ChevronFirst = _5, a.ChevronLast = ad, a.ChevronLeft = hd, a.ChevronLeftCircle = _, a
    .ChevronLeftSquare = x2, a.ChevronRight = td, a.ChevronRightCircle = a1, a
    .ChevronRightSquare = W2, a.ChevronUp = dd, a.ChevronUpCircle = h1, a.ChevronUpSquare = X2, a
    .ChevronsDown = Md, a.ChevronsDownUp = cd, a.ChevronsLeft = nd, a.ChevronsLeftRight = ed, a
    .ChevronsLeftRightEllipsis = pd, a.ChevronsRight = ld, a.ChevronsRightLeft = id, a
    .ChevronsUp = od, a.ChevronsUpDown = vd, a.Chrome = sd, a.Church = rd, a.Cigarette = yd, a
    .CigaretteOff = gd, a.Circle = fd, a.CircleAlert = G, a.CircleArrowDown = I, a
    .CircleArrowLeft = E, a.CircleArrowOutDownLeft = x, a.CircleArrowOutDownRight = W, a
    .CircleArrowOutUpLeft = X, a.CircleArrowOutUpRight = N, a.CircleArrowRight = K, a
    .CircleArrowUp = J, a.CircleCheck = j, a.CircleCheckBig = Q, a.CircleChevronDown = Y, a
    .CircleChevronLeft = _, a.CircleChevronRight = a1, a.CircleChevronUp = h1, a.CircleDashed =
    $d, a.CircleDivide = t1, a.CircleDollarSign = md, a.CircleDot = ud, a.CircleDotDashed = Cd, a
    .CircleEllipsis = Hd, a.CircleEqual = wd, a.CircleFadingArrowUp = Vd, a.CircleFadingPlus = Ad,
    a.CircleGauge = d1, a.CircleHelp = c1, a.CircleMinus = M1, a.CircleOff = Sd, a.CircleParking =
    e1, a.CircleParkingOff = p1, a.CirclePause = n1, a.CirclePercent = i1, a.CirclePlay = l1, a
    .CirclePlus = v1, a.CirclePower = o1, a.CircleSlash = Ld, a.CircleSlash2 = s1, a
    .CircleSlashed = s1, a.CircleStop = r1, a.CircleUser = y1, a.CircleUserRound = g1, a.CircleX =
    $1, a.CircuitBoard = Pd, a.Citrus = kd, a.Clapperboard = Bd, a.Clipboard = Ud, a
    .ClipboardCheck = Fd, a.ClipboardCopy = Dd, a.ClipboardEdit = C1, a.ClipboardList = Rd, a
    .ClipboardMinus = zd, a.ClipboardPaste = qd, a.ClipboardPen = C1, a.ClipboardPenLine = m1, a
    .ClipboardPlus = Td, a.ClipboardSignature = m1, a.ClipboardType = Zd, a.ClipboardX = bd, a
    .Clock = h3, a.Clock1 = Od, a.Clock10 = Gd, a.Clock11 = Id, a.Clock12 = Ed, a.Clock2 = xd, a
    .Clock3 = Wd, a.Clock4 = Xd, a.Clock5 = Nd, a.Clock6 = Kd, a.Clock7 = Jd, a.Clock8 = Qd, a
    .Clock9 = jd, a.ClockAlert = Yd, a.ClockArrowDown = _d, a.ClockArrowUp = a3, a.Cloud = y3, a
    .CloudAlert = t3, a.CloudCog = d3, a.CloudDownload = u1, a.CloudDrizzle = c3, a.CloudFog = M3,
    a.CloudHail = p3, a.CloudLightning = e3, a.CloudMoon = i3, a.CloudMoonRain = n3, a.CloudOff =
    l3, a.CloudRain = o3, a.CloudRainWind = v3, a.CloudSnow = s3, a.CloudSun = g3, a
    .CloudSunRain = r3, a.CloudUpload = H1, a.Cloudy = $3, a.Clover = m3, a.Club = C3, a.Code =
    u3, a.Code2 = w1, a.CodeSquare = N2, a.CodeXml = w1, a.Codepen = H3, a.Codesandbox = w3, a
    .Coffee = V3, a.Cog = A3, a.Coins = S3, a.Columns = V1, a.Columns2 = V1, a.Columns3 = A1, a
    .Columns4 = L3, a.Combine = f3, a.Command = P3, a.Compass = k3, a.Component = B3, a.Computer =
    F3, a.ConciergeBell = D3, a.Cone = R3, a.Construction = z3, a.Contact = q3, a.Contact2 = S1, a
    .ContactRound = S1, a.Container = T3, a.Contrast = Z3, a.Cookie = b3, a.CookingPot = U3, a
    .Copy = W3, a.CopyCheck = O3, a.CopyMinus = G3, a.CopyPlus = I3, a.CopySlash = E3, a.CopyX =
    x3, a.Copyleft = X3, a.Copyright = N3, a.CornerDownLeft = K3, a.CornerDownRight = J3, a
    .CornerLeftDown = Q3, a.CornerLeftUp = j3, a.CornerRightDown = Y3, a.CornerRightUp = _3, a
    .CornerUpLeft = a6, a.CornerUpRight = h6, a.Cpu = t6, a.CreativeCommons = d6, a.CreditCard =
    c6, a.Croissant = M6, a.Crop = p6, a.Cross = e6, a.Crosshair = n6, a.Crown = i6, a.Cuboid =
    l6, a.CupSoda = v6, a.CurlyBraces = L, a.Currency = o6, a.Cylinder = s6, a.Dam = r6, a
    .Database = $6, a.DatabaseBackup = g6, a.DatabaseZap = y6, a.Delete = m6, a.Dessert = C6, a
    .Diameter = u6, a.Diamond = V6, a.DiamondMinus = H6, a.DiamondPercent = L1, a.DiamondPlus =
    w6, a.Dice1 = A6, a.Dice2 = S6, a.Dice3 = L6, a.Dice4 = f6, a.Dice5 = P6, a.Dice6 = k6, a
    .Dices = B6, a.Diff = F6, a.Disc = q6, a.Disc2 = D6, a.Disc3 = R6, a.DiscAlbum = z6, a
    .Divide = T6, a.DivideCircle = t1, a.DivideSquare = j2, a.Dna = b6, a.DnaOff = Z6, a.Dock =
    U6, a.Dog = O6, a.DollarSign = G6, a.Donut = I6, a.DoorClosed = E6, a.DoorOpen = x6, a.Dot =
    W6, a.DotSquare = Y2, a.Download = X6, a.DownloadCloud = u1, a.DraftingCompass = N6, a.Drama =
    K6, a.Dribbble = J6, a.Drill = Q6, a.Droplet = Y6, a.DropletOff = j6, a.Droplets = _6, a
    .Drum = ac, a.Drumstick = hc, a.Dumbbell = tc, a.Ear = cc, a.EarOff = dc, a.Earth = f1, a
    .EarthLock = Mc, a.Eclipse = pc, a.Edit = e, a.Edit2 = g2, a.Edit3 = r2, a.Egg = ic, a
    .EggFried = ec, a.EggOff = nc, a.Ellipsis = k1, a.EllipsisVertical = P1, a.Equal = oc, a
    .EqualApproximately = lc, a.EqualNot = vc, a.EqualSquare = _2, a.Eraser = sc, a.EthernetPort =
    rc, a.Euro = gc, a.Expand = yc, a.ExternalLink = $c, a.Eye = uc, a.EyeClosed = mc, a.EyeOff =
    Cc, a.Facebook = Hc, a.Factory = wc, a.Fan = Vc, a.FastForward = Ac, a.Feather = Sc, a.Fence =
    Lc, a.FerrisWheel = fc, a.Figma = Pc, a.File = S8, a.FileArchive = kc, a.FileAudio = Fc, a
    .FileAudio2 = Bc, a.FileAxis3D = B1, a.FileAxis3d = B1, a.FileBadge = Rc, a.FileBadge2 = Dc, a
    .FileBarChart = F1, a.FileBarChart2 = D1, a.FileBox = zc, a.FileChartColumn = D1, a
    .FileChartColumnIncreasing = F1, a.FileChartLine = R1, a.FileChartPie = z1, a.FileCheck = Tc,
    a.FileCheck2 = qc, a.FileClock = Zc, a.FileCode = Uc, a.FileCode2 = bc, a.FileCog = q1, a
    .FileCog2 = q1, a.FileDiff = Oc, a.FileDigit = Gc, a.FileDown = Ic, a.FileEdit = Z1, a
    .FileHeart = Ec, a.FileImage = xc, a.FileInput = Wc, a.FileJson = Nc, a.FileJson2 = Xc, a
    .FileKey = Jc, a.FileKey2 = Kc, a.FileLineChart = R1, a.FileLock = jc, a.FileLock2 = Qc, a
    .FileMinus = _c, a.FileMinus2 = Yc, a.FileMusic = a8, a.FileOutput = h8, a.FilePen = Z1, a
    .FilePenLine = T1, a.FilePieChart = z1, a.FilePlus = d8, a.FilePlus2 = t8, a.FileQuestion =
    c8, a.FileScan = M8, a.FileSearch = e8, a.FileSearch2 = p8, a.FileSignature = T1, a
    .FileSliders = n8, a.FileSpreadsheet = i8, a.FileStack = l8, a.FileSymlink = v8, a
    .FileTerminal = o8, a.FileText = s8, a.FileType = g8, a.FileType2 = r8, a.FileUp = y8, a
    .FileUser = $8, a.FileVideo = C8, a.FileVideo2 = m8, a.FileVolume = H8, a.FileVolume2 = u8, a
    .FileWarning = w8, a.FileX = A8, a.FileX2 = V8, a.Files = L8, a.Film = f8, a.Filter = k8, a
    .FilterX = P8, a.Fingerprint = B8, a.FireExtinguisher = F8, a.Fish = z8, a.FishOff = D8, a
    .FishSymbol = R8, a.Flag = b8, a.FlagOff = q8, a.FlagTriangleLeft = T8, a.FlagTriangleRight =
    Z8, a.Flame = O8, a.FlameKindling = U8, a.Flashlight = I8, a.FlashlightOff = G8, a
    .FlaskConical = x8, a.FlaskConicalOff = E8, a.FlaskRound = W8, a.FlipHorizontal = N8, a
    .FlipHorizontal2 = X8, a.FlipVertical = J8, a.FlipVertical2 = K8, a.Flower = j8, a.Flower2 =
    Q8, a.Focus = Y8, a.FoldHorizontal = _8, a.FoldVertical = a7, a.Folder = P7, a.FolderArchive =
    h7, a.FolderCheck = t7, a.FolderClock = d7, a.FolderClosed = c7, a.FolderCode = M7, a
    .FolderCog = b1, a.FolderCog2 = b1, a.FolderDot = p7, a.FolderDown = e7, a.FolderEdit = U1, a
    .FolderGit = i7, a.FolderGit2 = n7, a.FolderHeart = l7, a.FolderInput = v7, a.FolderKanban =
    o7, a.FolderKey = s7, a.FolderLock = r7, a.FolderMinus = g7, a.FolderOpen = $7, a
    .FolderOpenDot = y7, a.FolderOutput = m7, a.FolderPen = U1, a.FolderPlus = C7, a.FolderRoot =
    u7, a.FolderSearch = w7, a.FolderSearch2 = H7, a.FolderSymlink = V7, a.FolderSync = A7, a
    .FolderTree = S7, a.FolderUp = L7, a.FolderX = f7, a.Folders = k7, a.Footprints = B7, a
    .ForkKnife = U0, a.ForkKnifeCrossed = b0, a.Forklift = F7, a.FormInput = $2, a.Forward = D7, a
    .Frame = R7, a.Framer = z7, a.Frown = q7, a.Fuel = T7, a.Fullscreen = Z7, a.FunctionSquare =
    a0, a.GalleryHorizontal = U7, a.GalleryHorizontalEnd = b7, a.GalleryThumbnails = O7, a
    .GalleryVertical = I7, a.GalleryVerticalEnd = G7, a.Gamepad = x7, a.Gamepad2 = E7, a
    .GanttChart = b, a.GanttChartSquare = l, a.Gauge = W7, a.GaugeCircle = d1, a.Gavel = X7, a
    .Gem = N7, a.Ghost = K7, a.Gift = J7, a.GitBranch = j7, a.GitBranchPlus = Q7, a.GitCommit =
    O1, a.GitCommitHorizontal = O1, a.GitCommitVertical = Y7, a.GitCompare = aM, a
    .GitCompareArrows = _7, a.GitFork = hM, a.GitGraph = tM, a.GitMerge = dM, a.GitPullRequest =
    iM, a.GitPullRequestArrow = cM, a.GitPullRequestClosed = MM, a.GitPullRequestCreate = eM, a
    .GitPullRequestCreateArrow = pM, a.GitPullRequestDraft = nM, a.Github = lM, a.Gitlab = vM, a
    .GlassWater = oM, a.Glasses = sM, a.Globe = gM, a.Globe2 = f1, a.GlobeLock = rM, a.Goal = yM,
    a.Grab = $M, a.GraduationCap = mM, a.Grape = CM, a.Grid = i, a.Grid2X2 = I1, a.Grid2X2Plus =
    G1, a.Grid2x2 = I1, a.Grid2x2Check = uM, a.Grid2x2Plus = G1, a.Grid2x2X = HM, a.Grid3X3 = i, a
    .Grid3x3 = i, a.Grip = AM, a.GripHorizontal = wM, a.GripVertical = VM, a.Group = SM, a
    .Guitar = LM, a.Ham = fM, a.Hammer = PM, a.Hand = RM, a.HandCoins = kM, a.HandHeart = BM, a
    .HandHelping = E1, a.HandMetal = FM, a.HandPlatter = DM, a.Handshake = zM, a.HardDrive = ZM, a
    .HardDriveDownload = qM, a.HardDriveUpload = TM, a.HardHat = bM, a.Hash = UM, a.Haze = OM, a
    .HdmiPort = GM, a.Heading = KM, a.Heading1 = IM, a.Heading2 = EM, a.Heading3 = xM, a
    .Heading4 = WM, a.Heading5 = XM, a.Heading6 = NM, a.HeadphoneOff = JM, a.Headphones = QM, a
    .Headset = jM, a.Heart = tp, a.HeartCrack = YM, a.HeartHandshake = _M, a.HeartOff = ap, a
    .HeartPulse = hp, a.Heater = dp, a.HelpCircle = c1, a.HelpingHand = E1, a.Hexagon = cp, a
    .Highlighter = Mp, a.History = pp, a.Home = x1, a.Hop = np, a.HopOff = ep, a.Hospital = ip, a
    .Hotel = lp, a.Hourglass = vp, a.House = x1, a.HousePlug = op, a.HousePlus = sp, a.IceCream =
    X1, a.IceCream2 = W1, a.IceCreamBowl = W1, a.IceCreamCone = X1, a.IdCard = rp, a.Image = wp, a
    .ImageDown = gp, a.ImageMinus = yp, a.ImageOff = $p, a.ImagePlay = mp, a.ImagePlus = Cp, a
    .ImageUp = up, a.ImageUpscale = Hp, a.Images = Vp, a.Import = Ap, a.Inbox = Sp, a.Indent = K1,
    a.IndentDecrease = N1, a.IndentIncrease = K1, a.IndianRupee = Lp, a.Infinity = fp, a.Info =
    Pp, a.Inspect = p0, a.InspectionPanel = kp, a.Instagram = Bp, a.Italic = Fp, a.IterationCcw =
    Dp, a.IterationCw = Rp, a.JapaneseYen = zp, a.Joystick = qp, a.Kanban = Tp, a.KanbanSquare =
    h0, a.KanbanSquareDashed = K2, a.Key = Up, a.KeyRound = Zp, a.KeySquare = bp, a.Keyboard = Ip,
    a.KeyboardMusic = Op, a.KeyboardOff = Gp, a.Lamp = Kp, a.LampCeiling = Ep, a.LampDesk = xp, a
    .LampFloor = Wp, a.LampWallDown = Xp, a.LampWallUp = Np, a.LandPlot = Jp, a.Landmark = Qp, a
    .Languages = jp, a.Laptop = _p, a.Laptop2 = J1, a.LaptopMinimal = J1, a.LaptopMinimalCheck =
    Yp, a.Lasso = he, a.LassoSelect = ae, a.Laugh = te, a.Layers = Q1, a.Layers2 = de, a.Layers3 =
    Q1, a.Layout = s2, a.LayoutDashboard = ce, a.LayoutGrid = Me, a.LayoutList = pe, a
    .LayoutPanelLeft = ee, a.LayoutPanelTop = ne, a.LayoutTemplate = ie, a.Leaf = le, a
    .LeafyGreen = ve, a.Lectern = oe, a.LetterText = se, a.Library = ge, a.LibraryBig = re, a
    .LibrarySquare = t0, a.LifeBuoy = ye, a.Ligature = $e, a.Lightbulb = Ce, a.LightbulbOff = me,
    a.LineChart = q, a.Link = we, a.Link2 = He, a.Link2Off = ue, a.Linkedin = Ve, a.List = Oe, a
    .ListCheck = Ae, a.ListChecks = Se, a.ListCollapse = Le, a.ListEnd = fe, a.ListFilter = ke, a
    .ListFilterPlus = Pe, a.ListMinus = Be, a.ListMusic = Fe, a.ListOrdered = De, a.ListPlus = Re,
    a.ListRestart = ze, a.ListStart = qe, a.ListTodo = Te, a.ListTree = Ze, a.ListVideo = be, a
    .ListX = Ue, a.Loader = Ie, a.Loader2 = j1, a.LoaderCircle = j1, a.LoaderPinwheel = Ge, a
    .Locate = We, a.LocateFixed = Ee, a.LocateOff = xe, a.Lock = Ne, a.LockKeyhole = Xe, a
    .LockKeyholeOpen = Y1, a.LockOpen = _1, a.LogIn = Ke, a.LogOut = Je, a.Logs = Qe, a.Lollipop =
    je, a.Luggage = Ye, a.MSquare = d0, a.Magnet = _e, a.Mail = nn, a.MailCheck = an, a
    .MailMinus = hn, a.MailOpen = tn, a.MailPlus = dn, a.MailQuestion = cn, a.MailSearch = Mn, a
    .MailWarning = pn, a.MailX = en, a.Mailbox = ln, a.Mails = vn, a.Map = An, a.MapPin = wn, a
    .MapPinCheck = sn, a.MapPinCheckInside = on, a.MapPinHouse = rn, a.MapPinMinus = yn, a
    .MapPinMinusInside = gn, a.MapPinOff = $n, a.MapPinPlus = Cn, a.MapPinPlusInside = mn, a
    .MapPinX = Hn, a.MapPinXInside = un, a.MapPinned = Vn, a.Martini = Sn, a.Maximize = fn, a
    .Maximize2 = Ln, a.Medal = Pn, a.Megaphone = Bn, a.MegaphoneOff = kn, a.Meh = Fn, a
    .MemoryStick = Dn, a.Menu = Rn, a.MenuSquare = c0, a.Merge = zn, a.MessageCircle = Wn, a
    .MessageCircleCode = qn, a.MessageCircleDashed = Tn, a.MessageCircleHeart = Zn, a
    .MessageCircleMore = bn, a.MessageCircleOff = Un, a.MessageCirclePlus = On, a
    .MessageCircleQuestion = Gn, a.MessageCircleReply = In, a.MessageCircleWarning = En, a
    .MessageCircleX = xn, a.MessageSquare = e9, a.MessageSquareCode = Xn, a.MessageSquareDashed =
    Nn, a.MessageSquareDiff = Kn, a.MessageSquareDot = Jn, a.MessageSquareHeart = Qn, a
    .MessageSquareLock = jn, a.MessageSquareMore = Yn, a.MessageSquareOff = _n, a
    .MessageSquarePlus = a9, a.MessageSquareQuote = h9, a.MessageSquareReply = t9, a
    .MessageSquareShare = d9, a.MessageSquareText = c9, a.MessageSquareWarning = M9, a
    .MessageSquareX = p9, a.MessagesSquare = n9, a.Mic = l9, a.Mic2 = a2, a.MicOff = i9, a
    .MicVocal = a2, a.Microchip = v9, a.Microscope = o9, a.Microwave = s9, a.Milestone = r9, a
    .Milk = y9, a.MilkOff = g9, a.Minimize = m9, a.Minimize2 = $9, a.Minus = C9, a.MinusCircle =
    M1, a.MinusSquare = M0, a.Monitor = D9, a.MonitorCheck = u9, a.MonitorCog = H9, a.MonitorDot =
    w9, a.MonitorDown = V9, a.MonitorOff = A9, a.MonitorPause = S9, a.MonitorPlay = L9, a
    .MonitorSmartphone = f9, a.MonitorSpeaker = P9, a.MonitorStop = k9, a.MonitorUp = B9, a
    .MonitorX = F9, a.Moon = z9, a.MoonStar = R9, a.MoreHorizontal = k1, a.MoreVertical = P1, a
    .Mountain = T9, a.MountainSnow = q9, a.Mouse = I9, a.MouseOff = Z9, a.MousePointer = G9, a
    .MousePointer2 = b9, a.MousePointerBan = U9, a.MousePointerClick = O9, a
    .MousePointerSquareDashed = J2, a.Move = hi, a.Move3D = h2, a.Move3d = h2, a.MoveDiagonal =
    x9, a.MoveDiagonal2 = E9, a.MoveDown = N9, a.MoveDownLeft = W9, a.MoveDownRight = X9, a
    .MoveHorizontal = K9, a.MoveLeft = J9, a.MoveRight = Q9, a.MoveUp = _9, a.MoveUpLeft = j9, a
    .MoveUpRight = Y9, a.MoveVertical = ai, a.Music = Mi, a.Music2 = ti, a.Music3 = di, a.Music4 =
    ci, a.Navigation = ii, a.Navigation2 = ei, a.Navigation2Off = pi, a.NavigationOff = ni, a
    .Network = li, a.Newspaper = vi, a.Nfc = oi, a.Notebook = yi, a.NotebookPen = si, a
    .NotebookTabs = ri, a.NotebookText = gi, a.NotepadText = mi, a.NotepadTextDashed = $i, a.Nut =
    ui, a.NutOff = Ci, a.Octagon = wi, a.OctagonAlert = t2, a.OctagonMinus = Hi, a.OctagonPause =
    d2, a.OctagonX = c2, a.Omega = Vi, a.Option = Ai, a.Orbit = Si, a.Origami = Li, a.Outdent =
    N1, a.Package = zi, a.Package2 = fi, a.PackageCheck = Pi, a.PackageMinus = ki, a.PackageOpen =
    Bi, a.PackagePlus = Fi, a.PackageSearch = Di, a.PackageX = Ri, a.PaintBucket = qi, a
    .PaintRoller = Ti, a.Paintbrush = Zi, a.Paintbrush2 = M2, a.PaintbrushVertical = M2, a
    .Palette = bi, a.Palmtree = f0, a.PanelBottom = Gi, a.PanelBottomClose = Ui, a
    .PanelBottomDashed = p2, a.PanelBottomInactive = p2, a.PanelBottomOpen = Oi, a.PanelLeft = l2,
    a.PanelLeftClose = e2, a.PanelLeftDashed = n2, a.PanelLeftInactive = n2, a.PanelLeftOpen = i2,
    a.PanelRight = xi, a.PanelRightClose = Ii, a.PanelRightDashed = v2, a.PanelRightInactive = v2,
    a.PanelRightOpen = Ei, a.PanelTop = Ni, a.PanelTopClose = Wi, a.PanelTopDashed = o2, a
    .PanelTopInactive = o2, a.PanelTopOpen = Xi, a.PanelsLeftBottom = Ki, a.PanelsLeftRight = A1,
    a.PanelsRightBottom = Ji, a.PanelsTopBottom = u2, a.PanelsTopLeft = s2, a.Paperclip = Qi, a
    .Parentheses = ji, a.ParkingCircle = e1, a.ParkingCircleOff = p1, a.ParkingMeter = Yi, a
    .ParkingSquare = n0, a.ParkingSquareOff = e0, a.PartyPopper = _i, a.Pause = al, a
    .PauseCircle = n1, a.PauseOctagon = d2, a.PawPrint = hl, a.PcCase = tl, a.Pen = g2, a.PenBox =
    e, a.PenLine = r2, a.PenOff = dl, a.PenSquare = e, a.PenTool = cl, a.Pencil = nl, a
    .PencilLine = Ml, a.PencilOff = pl, a.PencilRuler = el, a.Pentagon = il, a.Percent = ll, a
    .PercentCircle = i1, a.PercentDiamond = L1, a.PercentSquare = i0, a.PersonStanding = vl, a
    .PhilippinePeso = ol, a.Phone = Cl, a.PhoneCall = sl, a.PhoneForwarded = rl, a.PhoneIncoming =
    gl, a.PhoneMissed = yl, a.PhoneOff = $l, a.PhoneOutgoing = ml, a.Pi = ul, a.PiSquare = l0, a
    .Piano = Hl, a.Pickaxe = wl, a.PictureInPicture = Al, a.PictureInPicture2 = Vl, a.PieChart =
    U, a.PiggyBank = Sl, a.Pilcrow = Pl, a.PilcrowLeft = Ll, a.PilcrowRight = fl, a
    .PilcrowSquare = v0, a.Pill = Bl, a.PillBottle = kl, a.Pin = Dl, a.PinOff = Fl, a.Pipette =
    Rl, a.Pizza = zl, a.Plane = Zl, a.PlaneLanding = ql, a.PlaneTakeoff = Tl, a.Play = bl, a
    .PlayCircle = l1, a.PlaySquare = o0, a.Plug = Ol, a.Plug2 = Ul, a.PlugZap = y2, a.PlugZap2 =
    y2, a.Plus = Gl, a.PlusCircle = v1, a.PlusSquare = s0, a.Pocket = El, a.PocketKnife = Il, a
    .Podcast = xl, a.Pointer = Xl, a.PointerOff = Wl, a.Popcorn = Nl, a.Popsicle = Kl, a
    .PoundSterling = Jl, a.Power = jl, a.PowerCircle = o1, a.PowerOff = Ql, a.PowerSquare = r0, a
    .Presentation = Yl, a.Printer = av, a.PrinterCheck = _l, a.Projector = hv, a.Proportions = tv,
    a.Puzzle = dv, a.Pyramid = cv, a.QrCode = Mv, a.Quote = pv, a.Rabbit = ev, a.Radar = nv, a
    .Radiation = iv, a.Radical = lv, a.Radio = sv, a.RadioReceiver = vv, a.RadioTower = ov, a
    .Radius = rv, a.RailSymbol = gv, a.Rainbow = yv, a.Rat = $v, a.Ratio = mv, a.Receipt = fv, a
    .ReceiptCent = Cv, a.ReceiptEuro = uv, a.ReceiptIndianRupee = Hv, a.ReceiptJapaneseYen = wv, a
    .ReceiptPoundSterling = Vv, a.ReceiptRussianRuble = Av, a.ReceiptSwissFranc = Sv, a
    .ReceiptText = Lv, a.RectangleEllipsis = $2, a.RectangleHorizontal = Pv, a.RectangleVertical =
    kv, a.Recycle = Bv, a.Redo = Rv, a.Redo2 = Fv, a.RedoDot = Dv, a.RefreshCcw = qv, a
    .RefreshCcwDot = zv, a.RefreshCw = Zv, a.RefreshCwOff = Tv, a.Refrigerator = bv, a.Regex = Uv,
    a.RemoveFormatting = Ov, a.Repeat = Ev, a.Repeat1 = Gv, a.Repeat2 = Iv, a.Replace = Wv, a
    .ReplaceAll = xv, a.Reply = Nv, a.ReplyAll = Xv, a.Rewind = Kv, a.Ribbon = Jv, a.Rocket = Qv,
    a.RockingChair = jv, a.RollerCoaster = Yv, a.Rotate3D = m2, a.Rotate3d = m2, a.RotateCcw = ao,
    a.RotateCcwSquare = _v, a.RotateCw = to, a.RotateCwSquare = ho, a.Route = Mo, a.RouteOff = co,
    a.Router = po, a.Rows = C2, a.Rows2 = C2, a.Rows3 = u2, a.Rows4 = eo, a.Rss = no, a.Ruler =
    io, a.RussianRuble = lo, a.Sailboat = vo, a.Salad = oo, a.Sandwich = so, a.Satellite = go, a
    .SatelliteDish = ro, a.Save = mo, a.SaveAll = yo, a.SaveOff = $o, a.Scale = Co, a.Scale3D =
    H2, a.Scale3d = H2, a.Scaling = uo, a.Scan = ko, a.ScanBarcode = Ho, a.ScanEye = wo, a
    .ScanFace = Vo, a.ScanHeart = Ao, a.ScanLine = So, a.ScanQrCode = Lo, a.ScanSearch = fo, a
    .ScanText = Po, a.ScatterChart = O, a.School = Bo, a.School2 = B0, a.Scissors = Do, a
    .ScissorsLineDashed = Fo, a.ScissorsSquare = g0, a.ScissorsSquareDashedBottom = O2, a
    .ScreenShare = zo, a.ScreenShareOff = Ro, a.Scroll = To, a.ScrollText = qo, a.Search = Go, a
    .SearchCheck = Zo, a.SearchCode = bo, a.SearchSlash = Uo, a.SearchX = Oo, a.Section = Io, a
    .Send = xo, a.SendHorizonal = w2, a.SendHorizontal = w2, a.SendToBack = Eo, a
    .SeparatorHorizontal = Wo, a.SeparatorVertical = Xo, a.Server = Qo, a.ServerCog = No, a
    .ServerCrash = Ko, a.ServerOff = Jo, a.Settings = Yo, a.Settings2 = jo, a.Shapes = _o, a
    .Share = hs, a.Share2 = as, a.Sheet = ts, a.Shell = ds, a.Shield = ss, a.ShieldAlert = cs, a
    .ShieldBan = Ms, a.ShieldCheck = ps, a.ShieldClose = V2, a.ShieldEllipsis = es, a.ShieldHalf =
    ns, a.ShieldMinus = is, a.ShieldOff = ls, a.ShieldPlus = vs, a.ShieldQuestion = os, a
    .ShieldX = V2, a.Ship = gs, a.ShipWheel = rs, a.Shirt = ys, a.ShoppingBag = $s, a
    .ShoppingBasket = ms, a.ShoppingCart = Cs, a.Shovel = us, a.ShowerHead = Hs, a.Shrink = ws, a
    .Shrub = Vs, a.Shuffle = As, a.Sidebar = l2, a.SidebarClose = e2, a.SidebarOpen = i2, a
    .Sigma = Ss, a.SigmaSquare = y0, a.Signal = Bs, a.SignalHigh = Ls, a.SignalLow = fs, a
    .SignalMedium = Ps, a.SignalZero = ks, a.Signature = Fs, a.Signpost = Rs, a.SignpostBig = Ds,
    a.Siren = zs, a.SkipBack = qs, a.SkipForward = Ts, a.Skull = Zs, a.Slack = bs, a.Slash = Us, a
    .SlashSquare = $0, a.Slice = Os, a.Sliders = A2, a.SlidersHorizontal = Gs, a.SlidersVertical =
    A2, a.Smartphone = xs, a.SmartphoneCharging = Is, a.SmartphoneNfc = Es, a.Smile = Xs, a
    .SmilePlus = Ws, a.Snail = Ns, a.Snowflake = Ks, a.Sofa = Js, a.SortAsc = C, a.SortDesc = y, a
    .Soup = Qs, a.Space = js, a.Spade = Ys, a.Sparkle = _s, a.Sparkles = S2, a.Speaker = ar, a
    .Speech = hr, a.SpellCheck = dr, a.SpellCheck2 = tr, a.Spline = cr, a.Split = Mr, a
    .SplitSquareHorizontal = m0, a.SplitSquareVertical = C0, a.SprayCan = pr, a.Sprout = er, a
    .Square = sr, a.SquareActivity = L2, a.SquareArrowDown = k2, a.SquareArrowDownLeft = f2, a
    .SquareArrowDownRight = P2, a.SquareArrowLeft = B2, a.SquareArrowOutDownLeft = F2, a
    .SquareArrowOutDownRight = D2, a.SquareArrowOutUpLeft = R2, a.SquareArrowOutUpRight = z2, a
    .SquareArrowRight = q2, a.SquareArrowUp = b2, a.SquareArrowUpLeft = T2, a.SquareArrowUpRight =
    Z2, a.SquareAsterisk = U2, a.SquareBottomDashedScissors = O2, a.SquareChartGantt = l, a
    .SquareCheck = I2, a.SquareCheckBig = G2, a.SquareChevronDown = E2, a.SquareChevronLeft = x2,
    a.SquareChevronRight = W2, a.SquareChevronUp = X2, a.SquareCode = N2, a.SquareDashed = Q2, a
    .SquareDashedBottom = ir, a.SquareDashedBottomCode = nr, a.SquareDashedKanban = K2, a
    .SquareDashedMousePointer = J2, a.SquareDivide = j2, a.SquareDot = Y2, a.SquareEqual = _2, a
    .SquareFunction = a0, a.SquareGanttChart = l, a.SquareKanban = h0, a.SquareLibrary = t0, a
    .SquareM = d0, a.SquareMenu = c0, a.SquareMinus = M0, a.SquareMousePointer = p0, a
    .SquareParking = n0, a.SquareParkingOff = e0, a.SquarePen = e, a.SquarePercent = i0, a
    .SquarePi = l0, a.SquarePilcrow = v0, a.SquarePlay = o0, a.SquarePlus = s0, a.SquarePower =
    r0, a.SquareRadical = lr, a.SquareScissors = g0, a.SquareSigma = y0, a.SquareSlash = $0, a
    .SquareSplitHorizontal = m0, a.SquareSplitVertical = C0, a.SquareSquare = vr, a.SquareStack =
    or, a.SquareTerminal = u0, a.SquareUser = w0, a.SquareUserRound = H0, a.SquareX = V0, a
    .Squircle = rr, a.Squirrel = gr, a.Stamp = yr, a.Star = Cr, a.StarHalf = $r, a.StarOff = mr, a
    .Stars = S2, a.StepBack = ur, a.StepForward = Hr, a.Stethoscope = wr, a.Sticker = Vr, a
    .StickyNote = Ar, a.StopCircle = r1, a.Store = Sr, a.StretchHorizontal = Lr, a
    .StretchVertical = fr, a.Strikethrough = Pr, a.Subscript = kr, a.Subtitles = f, a.Sun = zr, a
    .SunDim = Br, a.SunMedium = Fr, a.SunMoon = Dr, a.SunSnow = Rr, a.Sunrise = qr, a.Sunset = Tr,
    a.Superscript = Zr, a.SwatchBook = br, a.SwissFranc = Ur, a.SwitchCamera = Or, a.Sword = Gr, a
    .Swords = Ir, a.Syringe = Er, a.Table = jr, a.Table2 = xr, a.TableCellsMerge = Wr, a
    .TableCellsSplit = Xr, a.TableColumnsSplit = Nr, a.TableOfContents = Kr, a.TableProperties =
    Jr, a.TableRowsSplit = Qr, a.Tablet = _r, a.TabletSmartphone = Yr, a.Tablets = ag, a.Tag = hg,
    a.Tags = tg, a.Tally1 = dg, a.Tally2 = cg, a.Tally3 = Mg, a.Tally4 = pg, a.Tally5 = eg, a
    .Tangent = ng, a.Target = ig, a.Telescope = lg, a.Tent = og, a.TentTree = vg, a.Terminal = sg,
    a.TerminalSquare = u0, a.TestTube = rg, a.TestTube2 = A0, a.TestTubeDiagonal = A0, a
    .TestTubes = gg, a.Text = ug, a.TextCursor = $g, a.TextCursorInput = yg, a.TextQuote = mg, a
    .TextSearch = Cg, a.TextSelect = S0, a.TextSelection = S0, a.Theater = Hg, a.Thermometer = Ag,
    a.ThermometerSnowflake = wg, a.ThermometerSun = Vg, a.ThumbsDown = Sg, a.ThumbsUp = Lg, a
    .Ticket = Rg, a.TicketCheck = fg, a.TicketMinus = Pg, a.TicketPercent = kg, a.TicketPlus = Bg,
    a.TicketSlash = Fg, a.TicketX = Dg, a.Tickets = qg, a.TicketsPlane = zg, a.Timer = bg, a
    .TimerOff = Tg, a.TimerReset = Zg, a.ToggleLeft = Ug, a.ToggleRight = Og, a.Toilet = Gg, a
    .Tornado = Ig, a.Torus = Eg, a.Touchpad = Wg, a.TouchpadOff = xg, a.TowerControl = Xg, a
    .ToyBrick = Ng, a.Tractor = Kg, a.TrafficCone = Jg, a.Train = L0, a.TrainFront = jg, a
    .TrainFrontTunnel = Qg, a.TrainTrack = Yg, a.TramFront = L0, a.Trash = ay, a.Trash2 = _g, a
    .TreeDeciduous = hy, a.TreePalm = f0, a.TreePine = ty, a.Trees = dy, a.Trello = cy, a
    .TrendingDown = My, a.TrendingUp = ey, a.TrendingUpDown = py, a.Triangle = iy, a
    .TriangleAlert = P0, a.TriangleRight = ny, a.Trophy = ly, a.Truck = vy, a.Turtle = oy, a.Tv =
    ry, a.Tv2 = k0, a.TvMinimal = k0, a.TvMinimalPlay = sy, a.Twitch = gy, a.Twitter = yy, a
    .Type = my, a.TypeOutline = $y, a.Umbrella = uy, a.UmbrellaOff = Cy, a.Underline = Hy, a
    .Undo = Ay, a.Undo2 = wy, a.UndoDot = Vy, a.UnfoldHorizontal = Sy, a.UnfoldVertical = Ly, a
    .Ungroup = fy, a.University = B0, a.Unlink = ky, a.Unlink2 = Py, a.Unlock = _1, a
    .UnlockKeyhole = Y1, a.Unplug = By, a.Upload = Fy, a.UploadCloud = H1, a.Usb = Dy, a.User =
    Iy, a.User2 = T0, a.UserCheck = Ry, a.UserCheck2 = F0, a.UserCircle = y1, a.UserCircle2 = g1,
    a.UserCog = zy, a.UserCog2 = D0, a.UserMinus = qy, a.UserMinus2 = R0, a.UserPen = Ty, a
    .UserPlus = Zy, a.UserPlus2 = z0, a.UserRound = T0, a.UserRoundCheck = F0, a.UserRoundCog =
    D0, a.UserRoundMinus = R0, a.UserRoundPen = by, a.UserRoundPlus = z0, a.UserRoundSearch = Uy,
    a.UserRoundX = q0, a.UserSearch = Oy, a.UserSquare = w0, a.UserSquare2 = H0, a.UserX = Gy, a
    .UserX2 = q0, a.Users = Ey, a.Users2 = Z0, a.UsersRound = Z0, a.Utensils = U0, a
    .UtensilsCrossed = b0, a.UtilityPole = xy, a.Variable = Wy, a.Vault = Xy, a.Vegan = Ny, a
    .VenetianMask = Ky, a.Verified = w, a.Vibrate = Qy, a.VibrateOff = Jy, a.Video = Yy, a
    .VideoOff = jy, a.Videotape = _y, a.View = a$, a.Voicemail = h$, a.Volleyball = t$, a.Volume =
    e$, a.Volume1 = d$, a.Volume2 = c$, a.VolumeOff = M$, a.VolumeX = p$, a.Vote = n$, a.Wallet =
    l$, a.Wallet2 = O0, a.WalletCards = i$, a.WalletMinimal = O0, a.Wallpaper = v$, a.Wand = o$, a
    .Wand2 = G0, a.WandSparkles = G0, a.Warehouse = s$, a.WashingMachine = r$, a.Watch = g$, a
    .Waves = $$, a.WavesLadder = y$, a.Waypoints = m$, a.Webcam = C$, a.Webhook = H$, a
    .WebhookOff = u$, a.Weight = w$, a.Wheat = A$, a.WheatOff = V$, a.WholeWord = S$, a.Wifi = B$,
    a.WifiHigh = L$, a.WifiLow = f$, a.WifiOff = P$, a.WifiZero = k$, a.Wind = D$, a
    .WindArrowDown = F$, a.Wine = z$, a.WineOff = R$, a.Workflow = q$, a.Worm = T$, a.WrapText =
    Z$, a.Wrench = b$, a.X = U$, a.XCircle = $1, a.XOctagon = c2, a.XSquare = V0, a.Youtube = O$,
    a.Zap = I$, a.ZapOff = G$, a.ZoomIn = E$, a.ZoomOut = x$, a.createElement = I0, a
    .createIcons = am, a.icons = W$
});
